...
from upyog.util.system import popen, pardir
from upyog.util.string import safe_decode
from upyog._compat import StringIO, EX_OK, input
...
def assert_input(
    capfd, text, output, expected=None, input_=None, stdout=None, input_args={}
):
    if expected == None:
        expected = output
